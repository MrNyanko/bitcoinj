...
public class Wallet extends BaseTaggableObject
     ...
     *
     * <p>
     * Once set up, calling {@link #doMaintenance(ScriptType, KeyParameter, boolean)} will create and possibly send rotation
     ...
     *
     * @param preferredScriptType script type for if a new seed needs to be created
     ...
     */
    public ListenableFuture<List<Transaction>> doMaintenance(Script.ScriptType preferredScriptType,
            @Nullable KeyParameter aesKey, boolean signAndSend) throws DeterministicUpgradeRequiresPassword {
        return doMaintenance(preferredScriptType, KeyChainGroupStructure.DEFAULT, aesKey, signAndSend);
    }
     ...
     */
    public ListenableFuture<List<Transaction>> doMaintenance(Script.ScriptType preferredScriptType,
            KeyChainGroupStructure structure, @Nullable KeyParameter aesKey, boolean signAndSend)
            throws DeterministicUpgradeRequiresPassword {
        List<Transaction> txns;
        lock.lock();
        keyChainGroupLock.lock();
        try {
            txns = maybeRotateKeys(preferredScriptType, structure, aesKey, signAndSend);
            if (!signAndSend)
    ...
    private List<Transaction> maybeRotateKeys(Script.ScriptType preferredScriptType, KeyChainGroupStructure structure,
            @Nullable KeyParameter aesKey, boolean sign) throws DeterministicUpgradeRequiresPassword {
        checkState(lock.isHeldByCurrentThread());
